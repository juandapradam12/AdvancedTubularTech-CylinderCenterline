...
uses
  SysUtils, Math, Matrix, ZInterceptService, PCAMultiPlaneIterationService, SmartInterceptService, CylinderLengthService, ReadDataUtils;
...
begin
  ...
  Intercept := ComputeSmartIntercept(Center3D, AxisDir);
